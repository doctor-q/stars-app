...
import cc.doctor.stars_app.databinding.FragmentSettingsAboutBinding;
...
public class SettingsAboutFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentSettingsAboutBinding.inflate(LayoutInflater.from(getContext()), container, false);
